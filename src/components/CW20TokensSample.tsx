...
const ANC = {
  'columbus-5': 'terra14z56l0fp2lsf86zy3hty2z47ezkhnthtr9yq76',
...
const BETH = {
  'columbus-5': 'terra1dzhzukyezv0etz22ud940z7adyv7xgcjkahuun',
...
function Component() {
  ...
  const chainID = useMemo(() => {
    return network.chainID === 'bombay-12' ? 'bombay-12' : 'columbus-5';
  }, [network.chainID]);
